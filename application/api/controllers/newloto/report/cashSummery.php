...
class cashSummery extends CAaskController {
    ...
    public function initialize() {
        ...
        try {
            ...
            $sl = $this->ask_mysqli->select("usertranscation", $_SESSION["db_1"]) . $this->ask_mysqli->whereBetweenDatesID('on_create', $request["dateform"], $request["dateto"],"userid",$request["own"]);
