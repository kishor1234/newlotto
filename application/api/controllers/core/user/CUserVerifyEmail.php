...
class CUserVerifyEmail extends CAaskController {
    ...
    public function initialize() {
        ...
        try {
            ...
            $result = $this->adminDB[$_SESSION["db_1"]]->query($this->ask_mysqli->update(array("isActive" => 1), "user") . $this->ask_mysqli->where($_POST, "AND"));
            if ($result) {
